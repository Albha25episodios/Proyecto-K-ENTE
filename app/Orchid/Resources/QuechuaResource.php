...
class QuechuaResource extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\Quechua::class;
    ...
    {
        return 'Gestión de palabras en Quechua';
    }
    ...
    public function fields(): array
    {
        return [
          Input::make('palabra')
              ->title('PALABRA')
              ->placeholder('ingrese palabra en quechua'),
